...
#### 提示缺少 `VCRUNTIME140.dll` 怎么办？
这个问题通常是因为旧版本 Windows 压缩包使用了动态运行库。

现在的新版本已经改为**自带 Windows C 运行时**，正常情况下下载新的 Release 压缩包后，不需要再单独安装 Visual C++ 运行库。

如果你下载的是较早版本，建议直接升级到最新 Release 再试。
